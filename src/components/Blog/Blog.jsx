    ...
    return (
        <div className='flex flex-col my-12 max-w-4xl mx-auto text-center gap-6'>
            <div className='border-y-2 border-gray-100'>
                <h1 className='my-5 text-3xl text-gray-900 font-semibold'>When should you use context API?</h1>
            ...
            <div className='border-y-2 border-gray-100'>
                <h1 className='my-5 text-3xl text-gray-900 font-semibold'>What is a custom hook?</h1>
            ...
            <div className='border-y-2 border-gray-100'>
                <h1 className='my-5 text-3xl text-gray-900 font-semibold'>What is useRef?</h1>
            ...
            <div className='border-y-2 border-gray-100'>
                <h1 className='my-5 text-3xl text-gray-900 font-semibold'>What is useMemo?</h1>
